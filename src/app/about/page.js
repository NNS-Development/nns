  ...
  const teamMembers = [
    {
      ...
      projects: [
        {
          name: "QR Code Gen - QR Code Gen from terminal",
          url: "https://github.com/NoobGrinder420/QR-code-gen",
        },
        {
          name: "PyGit - Own Git using Python",
          url: "https://github.com/NoobGrinder420/PyGit",
        },
      ],
      social: {
    ...
    },
    {
      ...
      role: "",
      image: "/natalie.jpeg",
      bio: "The brains, the brawn, but certainly not the beauty. A Developer who thinks she's funny.",
      projects: [
        {
          name: "meower-rs - A git wrapper made in rust",
          url: "https://github.com/ellipticobj/meower-rs",
        },
        {
          name: "sigma - A language created to help learning developers",
          url: "https://github.com/dimini171/sigma",
        },
      ],
      social: {
        github: "https://github.com/ellipticobj",
        twitter: "https://twitter.com/ellipticobj",
        linkedin: "",
      },
    },
    {
      ...
      projects: [
        {
          name: "SSTInc Stupidathon - Something stupid",
          url: "https://github.com/Sasutski/stupidathon",
        },
        {
          name: "Thank you website for my senior Isabelle",
          url: "https://github.com/Sasutski/isabelle",
        },
      ],
      social: {
